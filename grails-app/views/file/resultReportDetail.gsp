                ...
                <table align="center" class="table" cellpadding="5" cellspacing="0">
                    <thead>
                      <tr>
                        ...
                        <td width="100px"><g:message code="file.tags.label" /></td>
                        <td width="80px"><g:message code="file.period.label" /></td>
                        <td width="150px"><g:message code="file.note.label" /></td>
                      </tr>
                    </thead>
                    <tbody>
                        <g:each in="${fileListInstance}" status="i" var="fileInstance">
                            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                ...
                                <td>${fieldValue(bean: fileInstance, field: "tagList")}</td>
                                <td><g:formatDate date="${fileInstance?.periodInit}" format="${message (code: "default.date.format")}" /><br /><g:formatDate date="${fileInstance?.periodEnd}" format="${message (code: "default.date.format")}" /></td>
